...
- Tải xuống thư viện JDBC SQL Server: [SQL Server JDBC 8.2.2](https://github.com/AnestAcademy/Course-Java-JDBC/tree/main/Library) (_Chọn đúng phiên bản JDK được cài đặt trên máy_). 
